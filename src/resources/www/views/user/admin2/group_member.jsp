	...
	$.ajax({
		...
		success : function(data) {
			...
			if(data.list.length==0)
				pageNum = 1;
			else if(data.list.length%10==0)
				pageNum = (data.list.length)/10;
			else
				pageNum = parseInt((data.list.length)/10) + 1;
			$('#num2').text(pageNum);
...
<input type="hidden" id="group2" value="<%=request.getParameter("group") %>">
<input type="hidden" id="page" value="1">
<div style="background:#EEEEED; width:100%;">
  <div style="width:85%; min-width:1147px; margin: auto; height:auto; background:white; min-height:1800px;">
    ...
    <div id="about_main_1">
      ...
      <div style="height:1700px; border:1px dashed #999; margin-top:20px; border-radius:4px; ">
        ...
        <div>
          <input id="appendedInputButton search_submit" type="text" placeholder="&nbsp;成员姓名" autocomplete="off" style="width:172px; margin-top:20px; margin-left:20px;"> 
            <button class="btn"  type="button" value="快速搜索" style="margin-top:8px;">搜索</button>
        </div>
        <div id="box_outline">
          <!-- 
            <div id="box" >
        ...
        <div style="float:left; width:100%; margin:20px 100px;"  class="input-group">
