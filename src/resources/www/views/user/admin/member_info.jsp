...
$(document).ready(function(){
  ...
  $('#next').click(function(){
      var page = parseInt($('#page').val());
      if(page==parseInt($('#num2').val()))
    	  alertify.error("你已经在最后一页");
      else {
    	  $('#page').val(page--);
    	  $('#box_outline').empty();
    	  $.ajax({
  ...
  document.onkeydown=function(event){
      ...
      if(e && e.keyCode==13){ // enter 键
    	  var numberTest = /^\d{1}$/;
          var pageGo = $('#go').val();
          if(!pageGo.match(numberTest))
        	  return false;
          else if(pageGo > $('#num2').val() || pageGo<=0){
        	  return false;
          }
          else {
        	  $('#page').val(pageGo);
...
<div style="background:#EEEEED; width:100%;">
  <div style="width:85%; min-width:1147px; margin:0 auto; height:1700px; background:white;">
    ...
    <div style="float:left; width:100%; margin-top:20px; margin-left:180px;"  class="input-group">
