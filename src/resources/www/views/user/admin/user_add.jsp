...
$(document).ready(function(){
	...
	$('#save').click(function(){
		...
		$.ajax({
			...
			type : "post",
			dataType : "json",
			data : {"user_id":$('#user_id').val(),"name":name,"number":number,"birthday":birthday,"good_at":good_at,"prize":prize,"self_intro":self_intro,"tel":tel,"email":email},
			success : function(data) {
				if(data.result=="success"){
					alertify.success("成员添加成功！");
					jcl.go('/CippusWebProject/member_info');
				}
				else
					alertify.error("网络异常，请稍后再试！");
			}
...
#user_pic2 { width:250px; height:300px;  float:left; position:relative; left:35px; top:-580px; }
</style>
</head>
    ...
    <div id="about_main_1" style="width:800px; height:960px; float:left;  margin-top:30px; margin-left:30px;">
      <div style="width:100%; height:32px; background:#EEEEEE;">
        <div style="height:32px; background:url('${ctx}/images/t_bk_l.png') left no-repeat;">
          <span style="color:#FFF; font-size:12px; line-height:32px; margin-left:35px; font-family:'sans-serif'; font-weight:700;">添加成员</span>
        </div>
        <div style="height:900px; border:1px dashed #999; margin-top:20px; border-radius:4px; font-family:'微软雅黑';">
          <div style="width:400px; margin:25px 65px;">
            ...
            <div>
              ...
              <div style="width:300px; float:left; margin-left:20px;">
                <input type="text" id="name" class="info_input" value="">
              </div>
            </div>
            <br/><br/>
            <div>
              ...
              <div style="width:300px; float:left; margin-left:20px;">
                <input type="text" id="number" class="info_input" value="">
              </div>
            </div>
            <br/><br/>
            <!-- <div>
              ...
              <div style="width:300px; float:left; margin-left:20px;">
                <input type="text" id="user_group" class="info_input" value="">
              </div>
            </div> -->
            <br/><br/>
            <div>
              ...
              <div style="width:300px; float:left; margin-left:20px;">
                <input type="text" id="birthday" class="info_input" value="">
              </div>
            </div>
            <br/><br/>
            <div>
            ...
            <input type="button" id="save" value="确定添加">
