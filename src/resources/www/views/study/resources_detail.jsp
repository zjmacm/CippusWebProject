...
<div style="background:#EEEEED; width:100%;">
  <div style="width:85%; min-width:1147px; margin:0 auto; height:600px; background:white;">
    <div id="about_nav_1">
      ...
      <div id="about_nav_2">
        <div class="fun1 change" style="background:#FFF;color:black;border:1px solid #999;">
    ...
    <div id="about_main_1">
      <div style="width:100%; height:32px; background:#EEEEEE;">
        <div style="height:32px; background:url('${ctx}/images/t_bk_l.png') left no-repeat;">
          <span style="color:#FFF; font-size:12px; line-height:32px; margin-left:35px; font-family:'sans-serif'; font-weight:700;">资源详情</span>
        </div>
      </div>
