...
$(document).ready(function(){
	...
	$.ajax({
		...
		type : "post",
		dataType : "json",
		data : {"page":$('#current_page').val(),"title":$('#title_search').val()},
    ...
    $('#search_submit').click(function(){
    	jcl.go("/CippusWebProject/news_search?title_search="+$('#search').val());
    });
});
</script>
</head>
...
<input type="hidden" id="title_search" value="<%=request.getParameter("title_search") %>">
    ...
    <div id="about_main_1">
      <div style="width:100%; height:32px; background:#EEEEEE;">
        <div style="height:32px; background:url('${ctx}/images/t_bk_l.png') left no-repeat;">
          <span style="color:#FFF; font-size:12px; line-height:32px; margin-left:35px; font-family:'sans-serif'; font-weight:700;">新闻搜索</span>
        </div>
        ...
        <div class="input-append" style="margin:20px 0 0 20px;">
          <input class="span2" id="search" type="text" placeholder="&nbsp;按标题搜索" style="width:250px">
          <button class="btn" type="button" id="search_submit">搜索</button> 
        </div>
