  ...
  <div style="width:85%; min-width:1147px; height:42px; margin:-1px auto; background:#1E4A9E;">
    <div style="width:1024px; margin:-17px auto; height:42px;">
      <ul style="list-style:none;">
        <li class="fun" id="main" style="background:url('${ctx}/images/bg_nav_2.png'); color:white; font-size:18px;">首页</li>
        ...
        <li class="fun" id="project123" style="background:url('${ctx}/images/bg_nav_2.png'); color:white; font-size:18px;">项目展示</li>
