...
<div style="background:#EEEEED; width:100%;">
  <div style="width:85%; min-width:1147px; margin: auto; height:850px; background:white;">
    <div id="about_nav_1">
      <div id="about_tip">
      ...
      <div id="about_nav_2">
        ...
        <div class="fun1" id="project2" style="background:#67B6F1;color:#FFF;border:1px solid #67B6F1; margin-top:8px;">
